...
//               <br />
//               <span className="text-orange-600">National ID: </span>
//               {household.national_id}
//               <br />
//               <span className="text-orange-600">Phone Number:</span> {household.phone_number}
//               <br />
//               <span className="text-orange-600">Is Eligible: </span>
//               {household.is_eligible ? "Yes" : "No"}
//               <br />
...
//                       <span className="font-semibold text-orange-500">Child Name:</span>{" "}
//                       {child.child_name}
//                       <br />
